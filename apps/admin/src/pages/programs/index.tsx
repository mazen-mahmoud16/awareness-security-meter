...
import { deleteProgram, Program, programsQuery } from "../../api/program";
...
const Programs: React.FC<Props> = () => {
  ...
  return (
    <div className="px-6 py-6">
      <Helmet>
        <title>Awareness Admin | Programs</title>
      </Helmet>
...
const ProgramCard: React.FC<Program> = ({ name, description, id }) => {
  const navigate = useNavigate();
  ...
  return (
    <div className="px-4 py-4 mb-4 border border-gray-500 border-opacity-30 rounded-md flex justify-between">
      <div className="w-1/2">
        ...
        {/* <span className="font-semibold text-lg text-blue-400">{number}</span> */}
